# Allow dose skipping for deescalation in phase I/II
source("ORM_utils.R")
...
# Simulation function for ORM-phase I/II, allowing skipping dose when dose deescalation
ORM2.Eff.simu.fn <- function(phi, phiE, p.true, pE.true, ncohort=10, init.level=1,  cohortsize=3, add.args=list(),
                            ph1=0){
    # phi: Target DIL rate
